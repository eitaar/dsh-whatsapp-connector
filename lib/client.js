...
var IM_LOCALE_NAMESPACE = "dsh-whatsapp-connector";
...
var WHATSAPP_STYLE_ID = "dsh-whatsapp-connector-whatsapp-settings";
var CSS = String.raw`
.ddt-page {
  --ddt-accent: #1677ff;
...
var IM_STYLE_ID = "dsh-whatsapp-connector-settings";
var CSS2 = String.raw`
.dim-page {
...
@container (max-width: 680px) {
  ...
  .dim-panel .dim-credentialButton { gap: 5px; padding-inline: 8px; font-size: 12px; }
...
// plugin-src/client/index.js
var name = "dsh-whatsapp-connector-settings";
    ...
    h2(
      ...
      h2(
        ...
        h2(
          ...
          h2("strong", { className: "dim-brandName" }, "DSH WhatsApp Connector"),
